...
<body>
<form id="ticket" align="center" method="POST" action="<?php echo site_url('UserController/update/'. $ticket['ticket_no']); ?>">
...
<input type="submit" name="resubmit" value="Resubmit" id="submit" style="background-color:Tomato;border:1px rgb(99, 244, 255);height:30px;width:70px;">
</form>
</body>
</html>
